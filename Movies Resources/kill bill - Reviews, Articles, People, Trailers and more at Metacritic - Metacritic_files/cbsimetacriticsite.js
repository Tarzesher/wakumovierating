var s_tc_cbsimetacriticsite=new TagContainer('cbsimetacriticsite');
...
om.data = new Object();
om.data.is_dev=false;
om.data.rsids="cbsimetacriticsite,cbsicbsiall";
om.data.rsids_dev="cbsimetacriticsite-dev,cbsicbsiall-dev";

om.data.author_ids='';
om.data.author_names='';
om.data.blog_id='';
om.data.brand ='Metacritic';
om.data.channel='';
om.data.content_id='';
om.data.content_title='';
om.data.content_topic='';
om.data.content_type='';
om.data.demographics='';
om.data.edition='us';
om.data.hier1='';
om.data.ontology_id='';
om.data.page_guid='';
om.data.page_num='1';
om.data.page_title=document.title;
om.data.page_type_id='';
om.data.page_type='';
om.data.product_id='';
om.data.site_type='desktop web';
om.data.search_dimension='';
om.data.search_order='';
om.data.search_term='';
om.data.sections='';
om.data.server=document.domain;
om.data.tags='';
om.data.url='D=g';
om.data.user_status='';
om.data.user_agent='D=User-Agent';
om.data.evt_content_view = false;
om.data.evt_gallery_view = false;
om.data.evt_search_view = false;

om.data.err='';
om.data.sid='mc'; 
om.data.ssid=om.data.sid; 
om.data.page_name=om.data.sid+':'+document.location.pathname;;
// site-specific defaults variables

// initiate mapping
om.initTracking = function(s,p) {
  var d=om.data;
  
  // DW pageParams (if any)
  if (typeof(DW)!='undefined') {
  if (typeof(DW.pageParams)!='undefined'){
  if (typeof(DW.pageParams.pguid)!='undefined'){d.page_guid=DW.pageParams.pguid;}
  if (typeof(DW.pageParams.onid)!='undefined'){d.ontology_id=DW.pageParams.onid;}
  if (typeof(DW.pageParams.ptid)!='undefined'){d.page_type_id=DW.pageParams.ptid;}
  }}
  
  if(typeof(p)!='undefined') {
  if(typeof(p.context)!='undefined') {
  var c = p.context; 
  
  d.sid=(typeof(p.site_id)!='undefined')?p.site_id:d.sid;
  d.ssid=(typeof(p.source_site_id)!='undefined')?p.source_site_id:d.ssid;
  d.err=(typeof(p.error_code)!='undefined')?p.error_code:d.err;
  d.rsids=(typeof(p.rsids)!='undefined')?p.rsids:d.rsids;
  if(p.is_dev===true||p.is_dev==='true'||p.is_dev===1||p.is_dev==='1'){d.is_dev=true;}
  
  d.author_ids=(typeof(c.author_ids)!='undefined')?c.author_ids:d.author_ids;
  d.author_names=(typeof(c.author_names)!='undefined')?c.author_names:d.author_names;
  d.blog_id=(typeof(c.blog_id)!='undefined')?c.blog_id:d.blog_id;
  d.brand=(typeof(c.brand)!='undefined')?c.brand:d.brand;
  d.channel=(typeof(c.channel)!='undefined')?c.channel:d.channel;
  d.content_id=(typeof(c.content_id)!='undefined')?c.content_id:d.content_id;
  d.content_title=(typeof(c.content_title)!='undefined')?c.content_title:d.content_title;
  d.content_topic=(typeof(c.content_topic)!='undefined')?c.content_topic:d.content_topic;
  d.content_type=(typeof(c.content_type)!='undefined')?c.content_type:d.content_type;
  d.demographics=(typeof(c.demographics)!='undefined')?c.demographics:d.demographics;
  d.edition=(typeof(c.edition)!='undefined')?c.edition:d.edition;
  d.hier1=(typeof(c.hier1)!='undefined')?c.hier1:d.hier1;
  d.ontology_id=(typeof(c.ontology_id)!='undefined')?c.ontology_id:d.ontology_id;
  d.page_guid=(typeof(c.page_guid)!='undefined')?c.page_guid:d.page_guid;
  d.page_num=(typeof(c.page_num)!='undefined')?c.page_num:d.page_num;
  d.page_name=(typeof(c.page_name)!='undefined')?d.sid+':'+c.page_name:d.page_name;
  d.page_title=(typeof(c.page_title)!='undefined')?c.page_title:d.page_title;
  d.page_type_id=(typeof(c.page_type_id)!='undefined')?c.page_type_id:d.page_type_id;
  d.page_type=(typeof(c.page_type)!='undefined')?c.page_type:d.page_type;
  d.product_id=(typeof(c.product_id)!='undefined')?c.product_id:d.product_id;
  d.site_type=(typeof(c.site_type)!='undefined')?c.site_type:d.site_type;
  d.search_dimension=(typeof(c.search_dimension)!='undefined')?c.search_dimension:d.search_dimension;
  d.search_order=(typeof(c.search_order)!='undefined')?c.search_order:d.search_order;
  d.search_term=(typeof(c.search_term)!='undefined')?c.search_term:d.search_term;
  d.sections=(typeof(c.sections)!='undefined')?c.sections:d.sections;
  d.server=(typeof(c.server)!='undefined')?c.server:d.server;
  d.tags=(typeof(c.tags)!='undefined')?c.tags:d.tags;
  d.url=(typeof(c.url)!='undefined')?c.url:d.url;
  d.user_status=(typeof(c.user_status)!='undefined')?c.user_status:d.user_status;
  d.user_agent=(typeof(c.user_agent)!='undefined')?c.user_agent:d.user_agent;
  d.evt_content_view=(typeof(c.evt_content_view)!='undefined')?c.evt_content_view:d.evt_content_view;
  d.evt_gallery_view=(typeof(c.evt_gallery_view)!='undefined')?c.evt_gallery_view:d.evt_gallery_view;
  d.evt_search_view=(typeof(c.evt_search_view)!='undefined')?c.evt_search_view:d.evt_search_view;
  // site-specific var assignment
  }}
  // set site specific s vars  
  
  // set on-page events
  var om_ea=new Array();
  if(d.evt_content_view){om_ea.push("event30");}
  if(d.evt_gallery_view){om_ea.push("event32");}
  if(d.evt_search_view){om_ea.push("event48");}
  if(om_ea.length){s.events = om_ea.join(',');}
  
  // general s vars
  if(d.is_dev){s.sa(d.rsids_dev);}else{s.sa(d.rsids);}
  var om_sa=new Array(); var om_section_0;
  if(d.sections){ // manage the sections value if it's a csv
  om_sa=d.sections.split('|');
  if(typeof(om_sa[0])!='undefined'){om_section_0 = om_sa[0];} // top level section
  if(om_sa){om_sa.reverse();d.page_name=':'+om_sa.join(':');}
  if(d.page_type){d.page_name=':'+d.page_type+d.page_name;}
  if(d.page_num){d.page_name=':p'+d.page_num+d.page_name;}
  if(d.content_title){d.page_name=':'+d.content_title+d.page_name;}
  d.page_name=d.sid+d.page_name; // page name
  }
  if(d.product_id){ // product id
  var om_pa=new Array();
  id_array=d.product_id.split('|');
  if(typeof(id_array)!='undefined'){
  for(var i=0;i<id_array.length;i++){om_pa.push(';'+d.sid+':'+id_array[i]);}
  if(om_pa.length){s.products = om_pa.join('|');}
  }}
  if(om_section_0){s.channel=om_section_0;} // first channel definition
  if(d.sections && d.page_type){s.hier1=d.sid+':'+d.sections+'|'+d.page_type;s.eVar6=d.sections+'|'+d.page_type;}// first hier1 definition
  if(d.page_type){s.eVar10=d.page_type;s.prop10='D=v10';} // page type
  if(d.author_ids){s.list3=d.sid+':'+d.author_ids.toLowerCase();} // author ids
  if(d.author_names){s.eVar37=d.author_names.toLowerCase();s.prop37="D=v37";}// author names
  if(d.content_title){s.eVar20=d.content_title;s.prop20='D=v20';s.eVar21=d.content_title;s.prop21='D=v21';} // content title for q&a posts
  if(d.content_id){s.eVar30=d.sid+':'+d.content_id;s.prop30='D=v30';} // content id
  if(d.content_type){s.eVar22=d.content_type.toLowerCase();s.prop22='D=v22';} //content type
  if(d.content_topic){s.eVar23=d.content_topic.toLowerCase();s.prop23='D=v23';} // content topic
  if(d.blog_id||d.blog_name){s.eVar26=d.sid+':'+d.blog_id+'|'+d.blog_name;s.prop26="D=v26";} // blog ids
  if(d.demographics){s.eVar16=d.demographics;} // demographics
  if(d.user_status){s.eVar15=d.user_status;} //user logged in status 
  if(d.page_guid){s.eVar24=d.page_guid;s.prop24='D=v24';} // page-guid dw
  if(d.page_type_id){s.eVar12=d.page_type_id;s.prop12='D=v12';} // page type id dw
  if(d.ontology_id){s.eVar13=d.ontology_id;s.prop13='D=v13';} // ontology id dw
  if(d.page_name){s.pageName=d.page_name;}// pageName overwrite
  if(d.hier1){s.hier1=d.hier1;}// hier1 overwrite
  if(d.channel){s.channel=d.channel;} // channel overwrite
  if(d.server){s.server=d.server.toLowerCase();} //server
  if(d.search_term){s.eVar41=d.search_term;s.prop41='D=v41';} // search term
  if(d.search_dimension){s.eVar42=d.search_dimension;s.prop42='D=v42';} // search dimensions
  if(d.brand){s.eVar1=d.brand.toLowerCase();s.prop1="D=v1";} // brand
  if(d.edition){s.eVar2=d.edition.toLowerCase();s.prop2="D=v2";} // edition
  if(d.url){s.eVar7=d.url;s.prop7='D=v7';} // url
  if(d.user_agent){s.prop9=d.user_agent;} // user agent
  if(s.channel && d.page_type){s.eVar11='D=ch+":"+v10';s.prop11='D=v11';} // section and page type
  if(d.site_type){s.eVar3=d.site_type.toLowerCase();s.prop3="D=v3";} // site type
  if(d.page_title){s.eVar8=d.page_title;s.prop8='D=v8';} // browser title
  if(d.err){s.pageType='errorPage';s.pageName=d.sid+':'+d.err+':error:'+document.location.pathname+document.location.search;s.channel="error";} // overwrite any variables if error page is detected
  if(d.rsids){var om_sacc=new Array();om_sacc=d.rsids.split(','); if (typeof(om_sacc[0])!='undefined') {s.eVar5=om_sacc[0];s.prop5='D=v5';d.rsid=om_sacc[0];}}
  //s.contextData = d;
}
/********************** FEATURE TRACKING FUNCTIONS ***********************/
om.clearEvents = function() {
  s.linkTrackVars = 'None';
  s.linkTrackEvents = 'None';
};
om.trackClick = function(p) {
  if (typeof(p)!='undefined') {
    //console.log(p);
    s.linkTrackVars="events,channel,eVar1,eVar2,eVar3,eVar5,eVar6,eVar12,eVar13,eVar20,eVar21,eVar22,eVar26,eVar30,eVar37,eVar46,eVar64,eVar65,eVar66,list3,prop1,prop2,prop3,prop5,prop20,prop21,prop30";
...
om.trackSocialClick = function(p) {
  if (typeof(p)!='undefined') {
    s.linkTrackVars="events,channel,eVar1,eVar2,eVar3,eVar5,eVar6,eVar12,eVar13,eVar20,eVar21,eVar22,eVar26,eVar30,eVar37,eVar46,eVar64,eVar65,eVar66,list3,prop1,prop2,prop3,prop5,prop20,prop21,prop30";
    s.linkTrackEvents="event10";
    s.events='event10';
    s.eVar40=(p.item)?p.item:'NULL';
    s.tl(this, 'o', 'trackSocialClick');
    this.clearEvents();
  }
}
om.trackH5Video = function(params) {    
  if (typeof(params)!='undefined') {
    //console.log('trackH5Video:');
    //console.log(params);
    s.linkTrackVars =  (params.trackVars)?params.trackVars:'None';
    s.linkTrackEvents = (params.trackEvents)?params.trackEvents:'None';
    s.events = (params.events)?params.events:'None';  
    s.eVar1 = (params.eVar1)?params.eVar1:'';
    s.eVar2 = (params.eVar2)?params.eVar2:'';
    s.eVar3 = (params.eVar3)?params.eVar3:'';
    s.eVar5 = (params.eVar5)?params.eVar5:s.eVar5;
    s.prop5 = "D=v5";
    s.eVar25 = (params.eVar25)?params.eVar25:'';
    s.prop25 = "D=v25";
    s.eVar38 = (params.eVar38)?params.eVar38:'';
    s.eVar31 = (params.eVar31)?params.eVar31:'';
    s.prop31 = "D=v31";;        
    s.eVar32 = (params.eVar32)?params.eVar32:'';
    s.prop32 = "D=v32";;        
    s.eVar33 = (params.eVar33)?params.eVar33:'';        
    s.eVar34 = (params.eVar34)?params.eVar34:'';
    s.eVar39 = (params.eVar39)?params.eVar39:'';
    s.tl(this, 'o', 'trackH5Video');
    this.clearEvents();
  }
}
...
s.linkInternalFilters="javascript:,metacritic.com,cbsi.com,com.com,"+document.domain
...
function s_doPlugins(s) {
  ...
  if (typeof(omdata)=='object') {
    om.initTracking(s,omdata);
  }else{
    om.initTracking(s);
  }
  ...
  s.eVar54=s.getDaysSinceLastVisit('s_lv_'+om.data.sid);
...
s.setTagContainer("cbsimetacriticsite")
